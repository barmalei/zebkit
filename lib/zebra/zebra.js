...
pkg.CommandManager = Class(pkg.Manager, KeyListener, [
    ...
    function(){
        ...
        var commands = null;
        if (zebra.isMacOS) { 
            try { commands = JSON.parse(zebra.io.GET(pkg.$url + "commands.osx.json")); }
            catch(e) {}
        }
    ...
    if (zebra.isInBrowser) {
        ...
        if (e == null) {
            ...
            e.innerHTML = "<span id='zebra.fm.text'  style='display:inline;'>&nbsp;</span>" +
                          "<img  id='zebra.fm.image' style='display:inline;' src='data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAAApJREFUCNdjYAAAAAIAAeIhvDMAAAAASUVORK5CYII%3D' width='1' height='1'/>";
...
pkg.TextRender = Class(pkg.Render, zebra.util.Position.PositionMetric, [
    ...
    function setColor(c){
        if (c != this.color && (c == null || c.toString() != this.color.toString())) {
            this.color = c;
            return true;
        }
        return false;
...
pkg.Slider = Class(pkg.Panel, KeyListener, MouseListener, FocusListener,MouseMotionListener,
    ...
    function (o){
        ...
        this.render.setColor(this.scaleColor);
        this.orient = o;
...
pkg.TextField = Class(pkg.Label, pkg.KeyListener, pkg.MouseListener, pkg.MouseMotionListener,
    ...
    function $prototype() {
        ...
        this.nextWord_command = function() {
            var p = this.findNextWord(this.view.target, this.position.currentLine, this.position.currentCol, 1);
            if(p != null) this.position.setRowCol(p[0], p[1]);
        },

        this.prevWord_command = function() {
            var p = this.findNextWord(this.view.target, this.position.currentLine, this.position.currentCol, -1);
            if(p != null) this.position.setRowCol(p[0], p[1]);
        },

        this.pageUp_command = function() { this.position.seekLineTo(PO.UP, this.pageSize()); },
        this.pageDown_command = function() { this.position.seekLineTo(PO.DOWN, this.pageSize()); },
...
pkg.Grid = Class(ui.Panel, ui.MouseListener, ui.KeyListener, Position.PositionMetric,
        ...
        function setModel(d){
            if (d != this.model){
                this.clearSelect();
                if (Array.isArray(d)) data = new Matrix(d);
                if(this.model != null && this.model._) this.model._.remove(this);
                this.model = d;
                if (this.model != null && this.model._) this.model._.add(this);
...
pkg.GridStretchPan = Class(ui.Panel, zebra.layout.Layout, [
    function $prototype() {
        ...
        this.calcRowHeights = function(targetAreaW,targetAreaH,widths) { return null; };
