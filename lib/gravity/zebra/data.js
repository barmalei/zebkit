...
pkg.TreeModel = Class(function($) {
    ...
    $(function fire(id, i, mi){
        switch(id)
        {
            case INSERTED: this._.fireTo("itemInserted", this, i);break;
            case REMOVED : this._.fireTo("itemRemoved", this, i);break;
            case MODIFIED: this._.fireTo("itemModified", this, i); break;
            case MOVED   : this._.fireTo("itemMoved", this, i, mi); break; 
