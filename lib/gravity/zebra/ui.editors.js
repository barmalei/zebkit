...
var KeyEvent = zebra.ui.KeyEvent, Cursorable = zebra.ui.Cursorable, Color = zebra.util.Color;
...
pkg.ShaperBorder = Class(zebra.ui.view.View, Cursorable, [
    ...
    function paint(g,x,y,w,h,d){
        ...
        g.strokeRect(x + Math.floor(this.gap / 2), y + Math.floor(this.gap / 2), w - this.gap, h - this.gap);
    },
