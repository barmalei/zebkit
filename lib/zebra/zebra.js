...
pkg.Border = Class(pkg.View, [
    ...
    function(c){
        ...
        else this.$this(c, pkg.palette.borderColor);
    },
...
]), $clipboardTriggerKey = zebra.isMacOS ? KE.VK_CMD : KE.VK_CTRL;
...
var MDRAGGED = ME.DRAGGED, EM = null, MMOVED = ME.MOVED, MEXITED = ME.EXITED, 
    ...
    ME_STUB = new ME(null,  ME.PRESSED, 0, 0, 0, 1), meX, meY, $mousePressedY = 0;
...
var MB = zebra.util,Composite = pkg.Composite, rgb = zebra.util.rgb, ViewSet = pkg.ViewSet, ME = pkg.MouseEvent,
...
pkg.TextRender = Class(pkg.Render, zebra.util.Position.PositionMetric, [
    ...
    function setColor(c){
        if (zebra.isString(c)) c = new rgb(c);
        if (c != this.color && (c == null || !c.equals(this.color))) {
            this.color = c;
            return true;
        }
        return false;
...
pkg.Link = Class(pkg.Button, Cursorable, [
    ...
    function stateUpdated(o,n){
        this.$super(o, n);
        var r = this.view;
        if (r && !r.color.equals(this.colors[n])){
