...
var Dimension = zebra.util.Dimension, Color = zebra.util.Color, T = zebra.ui, L = zebra.layout;
...
pkg.ImgRender = Class(pkg.Render, [
    ...
    function paint(g,x,y,w,h,d){
        if(this.target != null){
            if(this.width > 0) g.drawImage(this.target, this.x, this.y, this.width, this.height, x, y, w, h);
            else g.drawImage(this.target, x, y, w, h);
        }
    },
...
pkg.TitledBorder = Class(pkg.View, [
    ...
    function (b, a){
        if(b == null && a != L.BOTTOM && a != L.TOP && a != L.CENTER) throw new Error("3002");
