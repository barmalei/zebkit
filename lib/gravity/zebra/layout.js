...
pkg.getYLoc = function(aoh,alignY,ah){
    ...
    throw new IllegalArgumentException("4007");
}
...
pkg.Layoutable = Class(L, [
    function() { 
        ...
        this.isLayoutValid = this.isValidValue = false;
        this.constraints = this.parent = null;
        this.kids = [];
        this.layoutVal = this.getDefaultLayout(); 
        this.isVisible = true;
    },
    ...
    function get(i){  
        if (i < 0 || i >= this.kids.length) throw new IllegalArgumentException();
        return this.kids[i]; 
    },
    ...
    function setLayout(m){
        if(!m) throw new IllegalArgumentException("4001"); 
        
        if(this.layoutVal != m){
            var pl = this.layoutVal;
            this.layoutVal = m;
            this.invalidate();
            this.layoutSet(pl);
        }
    ...
    function getLayout(){ return this.layoutVal; },

    function invalidate(){
        this.isValidValue = this.isLayoutValid = false;
        this.cachedWidth =  -1;
        if(this.parent != null) this.parent.invalidate();
    },

    function isValid(){ return this.isValidValue; },

    function validate(){
        this.validateMetric();
        if(this.width > 0 && this.height > 0 && !this.isLayoutValid && this.isVisible){
            this.layoutVal.layout(this);
    ...
    function getPreferredSize(){
        ...
        if(this.cachedWidth < 0){
            var ps = (this.psWidth < 0 || this.psHeight < 0) ? this.layoutVal.calcPreferredSize(this) : new Dimension(0,0);
        ...
        for(var i = 0;i < t.kids.length; i++){
            ...
            if(l.isVisible) {
                switch(l.constraints) {
                    ...
                    case pkg.LEFT: west = l; break;
                    case pkg.RIGHT: east = l; break;
                    default: throw new IllegalArgumentException("4002");
                }
            }
        }
        if(east != null){
...
pkg.FlowLayout = Class(L, [
    ...
    function (ax,ay,dir,g){
        if(dir != pkg.HORIZONTAL && dir != pkg.VERTICAL) throw new IllegalArgumentException("4003");
        this.ax = ax;
        this.ay = ay;
        this.direction = dir;
        this.gap = g;
...
pkg.ListLayout = Class(L, [
    ...
    function (ax,gap){
        if(ax !=  -1 && ax != pkg.LEFT && ax != pkg.RIGHT && ax != pkg.CENTER) throw new IllegalArgumentException("4004");
        this.ax = ax;
        this.gap = gap;
    },
...
pkg.PercentLayout = Class(L, [
    ...
    function (dir, gap){
        if(dir != pkg.HORIZONTAL && dir != pkg.VERTICAL) throw new IllegalArgumentException("4005");
        this.dir = dir;
        this.gap = gap;
    },
