...
pkg.Radial = Class(pkg.View, [
    function $prototype() {
        ...
        this.paint = function(g,x,y,w,h,d){
            var cx1 = w/2, cy1 = w/2, r1 = 10, r2 = w < h ? w : h;
...
var MB = zebra.util,Composite = pkg.Composite, ME = pkg.MouseEvent, MouseListener = pkg.MouseListener, 
    ...
    ChildrenListener = pkg.ChildrenListener, MouseMotionListener = pkg.MouseMotionListener, 
...
pkg.MouseWheelSupport = Class([
    ...
    function setup(canvas) {
        if (canvas == null) throw new Error("Null canvas");
        var $this = this;
...
pkg.Scroll = Class(pkg.Panel, MouseListener, MouseMotionListener,
    ...
    function $prototype() {
        ...
        this.endDragged = function (e){ this.startDragLoc = Number.MAX_VALUE; };
    ...
    function $prototype() {
        this.scrolled = function (psx,psy){
            try{
                ...
                if (this.hBar != null) this.hBar.position.setOffset( -this.scrollObj.scrollManager.getSX());
                if (this.vBar != null) this.vBar.position.setOffset( -this.scrollObj.scrollManager.getSY());
...
pkg.Tabs = Class(pkg.Panel, MouseListener, KeyListener, MouseMotionListener, [
    function $prototype() {
        this.mouseMoved = function(e) {
