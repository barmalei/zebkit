...
eval(zebra.Import("ui", "layout", "ui.view", "util"));
...
pkg.BasicUIDemo = new Class(pkg.DemoPan, function($) {
    $(function() {
        ...
        p_c.add(CENTER, p);
        p_c.add(BOTTOM, createButtonPan());
    ...
    function createProgressPan() {
        ...
        pr2.setMaxValue(4);
        pr2.setValue(1);
        pr2.setBundleView(new Gradient(rgb.lightGray, rgb.darkGray, HORIZONTAL));
