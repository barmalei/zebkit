...
pkg.Layoutable = Class(L, [
    function $prototype() {
        ...
        */
         ...
         * @return {Object} return {width:{Integer}, height:{Integer}} object
         */
...
pkg.Render = Class(pkg.View, [
    function $prototype() {
        ...
        /**
         * Set the given target object. The method triggers "targetWasChanged(oldTarget, newTarget)" execution if the method is declared. 
...
pkg.Gradient = Class(pkg.View, [
    function $prototype() {
        /**
         * Create instance of vertical or linear gradient
...
pkg.Picture = Class(pkg.Render, [
    function $prototype() {
        /**
         * Create instance of the given image render
...
pkg.ViewSet = Class(pkg.CompositeView, [
    function $prototype() {
        ...
        /**
         * Create instance of ViewSet that contains the passed set of Views instances
...
pkg.Manager = Class([
    ...
    /**
     *  Construct the manager. Manager is automatically registered as UI events listener for all implement by the manager UI event listeners
     *   @constructor
...
/**
 *  Paint UI manager abstract class. Extend it and 
 *  @class PaintManager
 */
...
/**
 * Splitter panel UI component. The component split it area horizontally or vertically into two parts. Every parts host an 
...
/**
 * Tabs UI panel. The component is used to organize switching between number of pages where every page contains an UI component.
 * @class Tabs
 * @extends zebra.ui.Panel
 */
