...
pkg.PaintManager = Class(pkg.Manager, function($) {
    $(function() {
        this.$super();
...
pkg.FocusManager = Class(pkg.Manager, MouseListener, CL, CNL, KeyListener, function($) {
    $(function() {
        this.$super();
...
pkg.CursorManager = Class(pkg.Manager, MouseListener, MouseMotionListener, function($) {
    $(function(){ 
        this.$super();
        this.cursors = {};
