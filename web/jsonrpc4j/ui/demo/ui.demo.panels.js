...
pkg.PanelsDemo = new Class(pkg.DemoPan, function($) {
    ...
    function createTitledPan() {
		...
		var p7 = new BorderPan(new zebra.ui.ImageLabel("image title", ui.get("butterfly")), new Label(""));
