    ...
    function $prototype() {
        ...
        this[''] = function() {
            ...
            if (arguments.length == 1) {
                ...
                if (arguments.length > 1) {
                    this.setRowsCols(arguments[0], arguments[0]);       
                }
            }
        };
    }
...
/**
 *  Mouse wheel support. Installs necessary mouse wheel listeners and handles mouse wheel events
 *  in Zebra UI.  
...
pkg.Checkbox = Class(pkg.StatePan, Actionable, [
    ...
    function $prototype() {
         ...
         * @param  {Boolean} b a state
         * @method setState
         * @deprecated use setValue method
         */
...
/**
 * Splitter panel UI component. The component splits its area horizontally or vertically into two parts. Every part hosts an 
 * UI component. A size of the parts can be controlled by mouse.
...
pkg.SplitPan = Class(pkg.Panel, [
    ...
    function $prototype() {
        ...
        /**
         * Set gripper maximal location
         * @param  {Integer} m  a maximal possible location
         * @method setRightMaxSize
         */
...
/**
 * Progress bar UI component.                                                                                                                                                                                                                           y -= (bundleSize + this.gap   [description]
 * @class Progress
 * @constructor
 * @extends {zebra.ui.Panel}
 */
