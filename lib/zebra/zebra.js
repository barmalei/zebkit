 ...
 * @api zebra.layout.getAbsLocation()
 */
 ...
 *      { x:{Integer}, y:{Integer} } 
 *
 * @method getRelLocation
 * @api zebra.layout.getRelLocation()
 */
        ...
        this.performInput = function(e){
            ...
            switch(e.UID) {
                case MUID:
                    ...
                    if (t[k] != null && 
                        t.$clazz != null && 
                        t.$clazz.$parents != null && 
                        t.$clazz.$parents[MouseListener] == true)
                    {
                        t[k].call(t, e);
                    }
    ...
    function $prototype() {
        ...
        this.mousePressed = function(id, e, button) {
           // release mouse pressed if it has not happened before but was not released
            ...
            for(var i = this.kids.length - 1; i >= 0; i--){
                var l = this.kids[i];
                if (l.layerMousePressed != null && l.layerMousePressed(x, y, button)) {
                    break;
                }
            }
        ...
        this.repaint = function(x,y,w,h) {
            ...
            // should be redrawn 
            if ((document.contains != null && document.contains(this.canvas) === false) ||
...
zebra.ready(
    ...
    function() {
        try {
            ...
            // it is necessary to pass focus to an element of DOM  
    ...
    function $prototype() {
        ...
        this.mouseWheelMoved = function(e){
            ...
            if (owner != null) {
                ...
                if (!e.detail) d[0] = -d[0]; // Chrome;Safari;IE
 ...
 *
 *      TOP or "top"  - title area will be placed on top of border line: 
 *                    ___| Title area |___ 
 *                    
 * 
 ...
 *                    
 * 
 *      BOTTOM or "bottom"  - title area will be placed underneath of border line: 
 *                     ____              ________
 *                         |  Title area | 
 *                    
 * 
...
pkg.ScrollPan = Class(pkg.Panel, [
    ...
    function $prototype() {
        ...
        /**
         * Callback method that is called every time a target component 
         * has been scrolled
         * @param  {Integer} psx previous scroll x location
         * @param  {Integer} psy previous scroll x location
         * @method  scrolled
         */
...
pkg.Tabs = Class(pkg.Panel, MouseListener, KeyListener, [
    function $prototype() {
        ...
        /**
         * Get a view to be rendered as the given tab page title
         * @param  {Integer} index a tab page index
         * @return {zebra.ui.View} a view to be used to paint the 
         * given tab page title
         * @method getTabView
         */
...
pkg.Toolbar = Class(pkg.Panel, pkg.ChildrenListener, [
    ...
    function addDecorative(c){
        this.add(new pkg.Toolbar.Constraints(true), c);
    },
...
pkg.TextField = Class(pkg.Label, pkg.KeyListener, pkg.MouseListener,
    ...
    function $prototype() {
         ...
         * @param {Integer} period a test field cursor blinking period (in milliseconds)
         * @method setBlinking
         */
    ...
    function $prototype() {
        ...
        this.layerMousePressed = function(x,y,mask){
            ...
            if (cnt > 0) {
                ...
                // otherwise looking for a window starting from the toppest one 
 ...
 */
 ...
 /**
  * Fired when a new Menubar item has been selected
         
         var mbar = new zebra.ui.Menubar();
         ...
         mbar._.add(function (src, index, prevIndex) {
             ...
         });

  * @event itemSelected
  * @param {zebra.ui.Menubar} src a menu bar UI component that triggers the event
  * @param {Integer} index an index of selected menu bar item, -1 when no item 
  * is selected
  * @param {Integer} prevIndex a previous selected item
  */
    ...
    function $prototype() {
        this.childInputEvent = function(e){
            ...
            switch(e.ID) {
                case MouseEvent.ENTERED:
                    if (this.over != target){
                        ...
                        if (this.selected != null) {
                            this.$select(this.over);
                        }
                        else {
                            this.repaint2(prev, this.over);
                        }
                    }
                    break;
                case MouseEvent.EXITED:
                    ...
                    if (p.x < 0 || p.y < 0 ||
                        p.x >= this.over.width || p.y >= this.over.height)
                    {
                        var prev = this.over;
                        this.over = null;
                        if (this.selected == null) {
        ...
        this.$select = function(b){
            if (this.selected != b){
                ...
                this._.fired(this, this.selected == null ? -1 : this.indexOf(this.selected),
                                   prev == null ? -1 : this.indexOf(prev));
            }
        };
...
pkg.PopupLayer = Class(pkg.BaseLayer, pkg.ChildrenListener, [
    ...
    function $prototype() {
        ...
        this.layerMousePressed = function(x,y,mask) {
            if (this.isLayerActiveAt(x, y) === false || this.getComponentAt(x, y) == this){
                if (this.kids.length > 0) this.removeAll();
                if (this.mbar != null) this.setMenubar(null);
                return false;
            }
            return true;
        };
        ...
        this.run = function(){
            if (this.tooltip == null){
                this.tooltip = this.target.tooltip != null ? this.target.tooltip
                                                           : this.target.getTooltip(this.target, this.tooltipX, this.tooltipY);
...
pkg.Grid = Class(ui.Panel, ui.MouseListener, ui.KeyListener,
         ...
         *         "offselection": <view to render selected row for the grid that doean't hold focus>
         *      }
         *
         * 
         *  @method  setViews
