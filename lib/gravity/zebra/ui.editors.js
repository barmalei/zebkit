...
var L = zebra.layout, Rectangle = JAVA.awt.Rectangle, Layer = zebra.ui.Layer;
var Point = JAVA.awt.Point, Cursor = JAVA.awt.Cursor, Dimension = JAVA.awt.Dimension
...
var KeyEvent = zebra.ui.KeyEvent, Cursorable = zebra.ui.Cursorable, Color = JAVA.awt.Color;
...
pkg.ShaperBorder = Class(zebra.ui.view.View, Cursorable, [
    ...
    function paint(g,x,y,w,h,d){
        var cx = Math.floor((w - this.gap)/2), cy = Math.floor((h - this.gap)/2);
        ...
        g.drawRect(x + Math.floor(this.gap / 2), y + Math.floor(this.gap / 2), w - this.gap, h - this.gap);
    },
...
pkg.ShaperPan = Class(Panel, Cursorable, Composite, FocusListener, KeyListener, [
    ...
    function (t){ 
        ...
        this.colors = [Color.lightGray, Color.blue];
...
pkg.DesignPan = Class(Panel, Composite, MouseListener,
    ...
    $(function () {
        ...
        this.colors = [ Color.black, Color.gray ];
    });
    ...
    $(function paintOnTop(g){
        if(this.selectedComp != null){
            ...
            if(this.selectedComp != this) this.borderView.paint(g, this.brX, this.brY, this.brW, this.brH, this);
                ...
                g.drawRect(left, top, ew - 1, eh - 1);
                g.drawRect(left + 1, top + 1, ew - 3, eh - 3);
            }
        }
    });
        ...
        try{
            ...
            if(prevParent != null){
                ...
                if(prevParent != newParent){
                    var constraints = null, newParentLI = null;  //!!!Editors.getLayoutHelper(newParent.getLayout());
                    if(newParentLI != null){
                        if(newParentLI.canBeAdded(newParent, newParent.getLayout(), this.selectedComp)){
                            constraints = newParentLI.getDefaultConstraints(newParent, newParent.getLayout());
                        }
                        else return ;
                    }
