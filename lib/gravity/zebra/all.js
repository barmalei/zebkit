...
pkg.Panel.prototype.notifyRender = function(o,n){
...
pkg.Tree = Class(ui.Panel, ui.view.ViewProvider, ui.MouseListener, ui.KeyListener,
...
pkg.Grid = Class(ui.Panel, ui.MouseListener, ui.KeyListener, Position.PositionMetric ,pkg.GridMetrics,
        ...
        $(function showTopHeader() { 
            return this.showHeader(Grid.TOP_CAPTION_EL, null); 
        });
