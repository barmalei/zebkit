...
pkg.getRequest = function(type) {
    if (zebra.isIE || type === 0 || type === 1) {
        ...
        obj.send = function(data) {
            ...
            this.ontimeout = this.onprogress = function () { };

            this.onerror = function() {
                req.readyState = 4;
                req.status = 404;
                if (req._async && req.onreadystatechange) {
 ...
 * Shortcut method to perform asynchronous or synchronous HTTP GET requests.
        ...
        zebra.io.GET("http://test.com", function(res, request) {
            // handle result
            ...
        });
 ...
 * Shortcut method to perform asynchronous or synchronous HTTP POST requests.
        ...
        zebra.io.POST("http://test.com", function(res, request) {
            // handle result
            ...
        });
        ...
        zebra.io.POST("http://test.com", "request", function(res, request) {
            // handle result
        });
            ...
            (function() {
                ...
                $this[name] = function() {
                    ...
                    if (args.length > 0 && typeof args[args.length - 1] == "function") {
                        ...
                        return this.send(url, this.encode(name, args), function(res) {
                                                                            var r = null;
                                                                            try { r = $this.decode(res); }
                                                                            catch(e) {  r = e; }
                                                                            callback(r);
                                                                       });
                    }
    ...
    function $prototype() {
        ...
        this.compMoved = function(t, px, py){
            ...
            if (p != null && w > 0 && h > 0){
                ...
                this.repaint(p, nx, ny, (w1 < w2 ? w1 : w2) + 2,
                                        (h1 < h2 ? h1 : h2) + 2);
            }
        };
...
pkg.zCanvas = Class(pkg.Panel, [
    ...
    function $prototype() {
        ...
        this.focusGained = function(e){
            ...
            {
                var d = pkg.focusManager.prevFocusOwner.getCanvas();
                if (d == this)  { 
    ...
    function $prototype() {
        ...
        this.keyReleased = function(e){
            ...
            var prev = this.state;
                ...
                if (prev == PRESSED_OUT) this.updateState(OUT);
            }
        };
...
pkg.Extender = Class(pkg.Panel, [
    ...
    function $clazz() {
        ...
        this.TogglePan = Class(pkg.ViewPan, MouseListener, Cursorable, [
            function $prototype() {
                this.mousePressed = function(e){
                    if (e.isActionMask()) {
 ...
 */
pkg.BaseCaption = Class(ui.Panel, ui.MouseListener, ui.Cursorable, [
    function $prototype() {
        /**
